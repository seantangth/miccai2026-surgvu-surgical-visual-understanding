...
# 用法：RUN_TAG=v7_rA MODELS=rtdetr-l.pt EPOCHS=30 PATIENCE=30 CLOSE_MOSAIC=5 BATCH=32 WAIT_TARS="pseudo_scale_r1_shard0.tar.gz pseudo_scale_r1_shard1.tar.gz pseudo_llm_v1.tar.gz" WAIT_MIN=90 \
...
OPT_TARS="${OPT_TARS:-pseudo_llm_v1.tar.gz}"        # 等不到也照跑
...
rm -rf ~/cat1_yolo ~/cat1_yolo_v3 ~/pseudo_rare_v3 ~/pseudo_rare_v5 ~/pseudo_agy_v3 ~/pseudo_agy_v5 ~/pseudo_agybox_v1 ~/pseudo_scale_r1_shard* ~/pseudo_llm_v1
rm -f ~/pseudo_scale_r1_shard*.tar.gz ~/pseudo_llm_v1.tar.gz
